...
#add item
set1.add('Pooja') #added alphabetically
set1
set1.add('A')
set1
set1.add()
...
set1.update('XYZ') #this will add individual as square bracket is not gien due to which it might take as individual letters instead of element of a list
set1
