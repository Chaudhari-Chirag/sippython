# -*- coding: utf-8 -*-
"""
Created on Sun Jun 16 11:41:40 2019
...
#%%
#Difference between list and tuple explained
...
type(a)
a[0] = 'orange'
#TypeError: 'tuple' object does not support item assignment - this error is shown as tupe is immutable
...
#converting above data into dataframes

import pandas as pd
data = {1:['Ramesh'], 2:['Suresh'], 3:['Priyanka']}   
df = pd.DataFrame(data)
df

#copynig the dictonary
boys = {'tim': 18 , 'sam':23}
boys
studentx = boys.copy()
studentx
