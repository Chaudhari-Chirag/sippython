...
prestige = sm.datasets.get_rdataset("Duncan", "carData", cache=True).data #package name changed form car to carData
print(prestige.head())
...
#%%  NOt working
import statsmodels.api as sm
duncan_prestige = sm.datasets.get_rdataset("carData")
