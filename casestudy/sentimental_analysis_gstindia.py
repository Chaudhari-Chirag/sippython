...
class SentimentAnalysis:
    ...
    def DownloadData(self):
        ...
        csvFile = open('result.csv', 'a')  #r - read, w -new, a -append,r+ read&write
        
        # Use csv writer
        csvWriter = csv.writer(csvFile)  #to write the data into csv file
        ...
        for tweet in self.tweets:
            ...
            polarity += analysis.sentiment.polarity  #adding polarities to find average later
